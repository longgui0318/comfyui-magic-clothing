...
class ClothAdapter:
    def __init__(self, sd_pipe, ref_path, device, enable_cloth_guidance, seg_path=None):
        ...
        if seg_path is not None:
            self.set_seg_model(seg_path)
        self.attn_store = {}

    def set_seg_model(self,seg_path):
        self.seg_net = load_seg_model(seg_path, device=self.device)
